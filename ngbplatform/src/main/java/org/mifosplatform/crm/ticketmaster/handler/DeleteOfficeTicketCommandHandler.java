...
@Service
@CommandType(entity = "OFFICETICKET", action = "CLOSE")
public class DeleteOfficeTicketCommandHandler implements
		NewCommandSourceHandler {
	private final TicketMasterWritePlatformService ticketMasterWritePlatformService;
	@Autowired
	DeleteOfficeTicketCommandHandler(final TicketMasterWritePlatformService ticketMasterWritePlatformService){
		this.ticketMasterWritePlatformService=ticketMasterWritePlatformService;
	}
	@Override
	public CommandProcessingResult processCommand(JsonCommand command) {
		// TODO Auto-generated method stub
		return this.ticketMasterWritePlatformService.closeOfficeTicket(command);
	}
