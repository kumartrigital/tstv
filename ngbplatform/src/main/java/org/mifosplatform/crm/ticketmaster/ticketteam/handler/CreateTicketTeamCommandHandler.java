...
@Service
@CommandType(entity = "TICKETTEAM", action = "CREATE")
public class CreateTicketTeamCommandHandler implements NewCommandSourceHandler{
	...
	@Autowired
	public CreateTicketTeamCommandHandler(TicketTeamWritePlatformService ticketteamWritePlatformService) {
	...
	public CommandProcessingResult processCommand(JsonCommand command) {
		return this.ticketteamWritePlatformService.createTicketTeam(command);
	}
