...
public class DateTimeUtils {
    ...
    public static DateTime getDateOfTenant() {
        return getLocalDateTimeOfTenant().toDateTime();
    }
    ...
    public static LocalDateTime parseLocalDate(final String stringDate, final String pattern) {
