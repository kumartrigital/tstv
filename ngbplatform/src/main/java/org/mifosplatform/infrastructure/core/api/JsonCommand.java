...
public final class JsonCommand {
    ...
    public LocalDateTime localDateTimeValueOfParameterNamed(final String parameterName) {
        return this.fromApiJsonHelper.extractLocalDateTimeNamed(parameterName, parsedCommand);
    }
    ...
    public String stringValueOfParameterName(final String parameterName) {
        final String value = this.fromApiJsonHelper.extractStringNamed(parameterName, parsedCommand);
