...
public class Document extends AbstractPersistable<Long> {
    ...
    @Column(name = "child_entity_id", length = 1000)
    ...
    public static Document createNew(final String parentEntityType, final Long parentEntityId, final String name, final String fileName,
            final Long size, final String type, final String description, final String location, final Long childEntityId) {
        return new Document(parentEntityType, parentEntityId, name, fileName, size, type, description, location, childEntityId);
    }
    ...
    private Document(final String parentEntityType, final Long parentEntityId, final String name, final String fileName, final Long size,
            final String type, final String description, final String location, final Long childEntityId) {
    ...
    public void setChildEntityId(final Long childEntityId) {
        this.childEntityId = childEntityId;
    }
