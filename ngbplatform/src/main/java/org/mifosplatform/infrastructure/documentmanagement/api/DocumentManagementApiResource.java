...
public class DocumentManagementApiResource {
    ...
    public String createDocument(@PathParam("entityType") final String entityType, @PathParam("entityId") final Long entityId,
            ...
            @FormDataParam("name") final String name, @FormDataParam("description") final String description,@FormDataParam("childEntityId") final Long childEntityId) {
         ...
         * permissable
         **/
        final DocumentCommand documentCommand = new DocumentCommand(null, childEntityId, entityType, entityId, name, fileDetails.getFileName(),
    ...
    public Response downloadFile(@PathParam("entityType") final String entityType, @PathParam("entityId") final Long entityId,
        ...
        final String fileLocation = documentData.getLocation();
        final File file = new File(fileLocation);
        
        final ResponseBuilder response = Response.ok(file);
        response.header("Content-Disposition", "attachment; filename=\"" + fileLocation + "\"");
	...
	public String addTicketDetails(@PathParam("ticketId") Long ticketId,@PathParam("entityType") String entityType, @PathParam("entityId") Long entityId,
            ...
            @FormDataParam("subCategory") String subCategory,@FormDataParam("ticketURL") String ticketURL, @FormDataParam("problemCode") Integer problemCode, @FormDataParam("priority") String priority) {
        ...
        TicketMasterCommand ticketMasterCommand=new TicketMasterCommand(ticketId,comments,status,assignedTo,createdbyId,null,problemCode,priority,subCategory);
        DocumentCommand documentCommand=null;
