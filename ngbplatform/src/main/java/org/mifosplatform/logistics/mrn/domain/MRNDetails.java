...
public class MRNDetails extends AbstractAuditableCustom<AppUser, Long>{
	...
	private MRNDetails(final Date requestedDate, final Long fromOffice, final Long toOffice, final Long orderdQuantity, final Long itemMasterId,final String notes){
...
//		final Date requestedDate  = command.DateValueOfParameterNamed("requestedDate");
		...
		return new MRNDetails(requestedDate, fromOffice, toOffice, orderdQuantity, itemMasterId,notes);
	}
