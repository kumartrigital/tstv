...
public class ItemApiResource {
	...
	public ItemApiResource(final PlatformSecurityContext context,final PortfolioCommandSourceWritePlatformService portfolioCommandSourceWritePlatformService,
			...
			final SupplierReadPlatformService supplierReadPlatformService, final EnumReadplaformService enumReadplaformService){
	...
	private ItemData handleTemplateData(ItemData itemData) {
		...
		final ConfigurationPropertyData configurationPropertyData = this.configurationReadPlatformService.retrieveGlobalConfigurationByName("item-supplier-mapping");
