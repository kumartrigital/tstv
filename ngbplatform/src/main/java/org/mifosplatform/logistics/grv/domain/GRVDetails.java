...
@Entity
@Table(name="b_grv")
public class GRVDetails extends AbstractAuditableCustom<AppUser, Long>{
	...
	private GRVDetails(final Date requestedDate, final Long fromOffice, final Long toOffice, final Long orderdQuantity, final Long itemMasterId, final String notes){
	...
	public static GRVDetails formJson(JsonCommand command) throws ParseException{
//		final Date requestedDate  = command.DateValueOfParameterNamed("requestedDate");
		...
		return new GRVDetails(requestedDate, fromOffice, toOffice, orderdQuantity, itemMasterId, notes);
	}
