...
public class ProvisioningApiConstants {
	...
	public static final String REQUEST_SWAPDEVICE="SWAP_DEVICE";
	public static final String REQUEST_ADD_PLAN="ADD_PLAN";
	public static final String REQUEST_RETRACK="RETRACK";
	public static final String REQUEST_SWAPSTB="SWAP_STB";
	public static final String REQUEST_SWAPVC="SWAP_VC";
	public static final String REQUEST_RESETPIN="RESETPIN";
	public static final String REQUEST_MODIFY_SERVICE="MODIFY_SERVICE";
	//Json Data
