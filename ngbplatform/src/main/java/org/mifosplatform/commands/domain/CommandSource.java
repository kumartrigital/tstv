...
/*    @Column(name = "transaction_id", length = 100)
    ...
    public static CommandSource source( final String actionName,final JsonCommand command, final AppUser maker) {
        return new CommandSource(actionName, command.entityName(), command.getUrl(), command.entityId(), command.subentityId(),
                command.json(), maker, DateTime.now());
    }
