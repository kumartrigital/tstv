...
public class MessageGmailBackedPlatformEmailService implements MessagePlatformEmailService {
	...
	/*@Override
	public String sendToMobile(String message, Long id, String messageTo, String messageBody){
	     try {
	        
	                    URL url = new URL("https://smsapi.engineeringtgr.com/send/?Mobile="+987764334+"&Password='Welcome@123'&Message="+messageBody+"test&To="+messageTo+"&Key=suredUEnM7ervH5L0ZtPTfi");
	         String urlString = "http://31.132.7.244:8001/api?username=arewah&password=z19Tk02F&ani=ARWTRL&dnis="+messageTo+"&message="+messageBody+"&command=submit&serviceType=&longMessageMode=cut[1]";           
