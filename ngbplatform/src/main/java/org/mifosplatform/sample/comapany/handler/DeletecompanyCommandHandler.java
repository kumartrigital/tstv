...
public class DeletecompanyCommandHandler implements NewCommandSourceHandler {

	private final BroadcasterWritePlatformService broadcasterWritePlatformService;
	
	@Autowired
	public DeletecompanyCommandHandler(final BroadcasterWritePlatformService broadcasterWritePlatformService) {
