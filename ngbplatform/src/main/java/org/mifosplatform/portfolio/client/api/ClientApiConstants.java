...
public class ClientApiConstants {
    ...
    public static final String lcoMovementParamName= "lcoMovement";
    public static final String officePoId = "officePoId";
    public static final String officeTransfer = "officeTransfer";
    public static final String idKeyParamName = "idKey";
    public static final String idValueParamName = "idValue";
    // response parameters
 ...
 /*  public static String billCurrencyParamName="billCurrency";
   ...
   public static String billFrequencyParamName="billFrequency";*/
    public static final String addressKeyParamName="addressType";
    public static final String zipParamName="zipCode";
    ...
    public static final Set<String> CLIENT_CREATE_REQUEST_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(localeParamName,titleParamName,
            ...
            "parentPoId",idKeyParamName,idValueParamName,"generatedKey", "returnUrl",
            "billMode","district","address","parentId","parentpoId","addressType", "authToken", "lat", "long","uniqueReferenceNo"));
    ...
    public static final Set<String> CLIENT_UPDATE_REQUEST_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(localeParamName,titleParamName,
            ...
            emailParamName,officeIdParamName,groupParamName,entryTypeParamName,userNameParamName,passwordParamName,officePoId,officeTransfer,
            jobTitleParamName,fiananceIdParamName,utsCustomerIdParamName,genderParamName,dateOfBirthParamName,nationalityParamName,idTypeParamName,
            idNumberParamName,remarksParamName,preferredLangParamName,ageGroupParamName,preferredCommunicationParamName,addressKeyParamName,addressNoParamName,
            streetParamName,zipParamName,cityParamName,stateParamName,countryParamName,districtParamName, lcoMovementParamName,idKeyParamName,idValueParamName,idParamName));
