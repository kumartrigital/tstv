...
public class OrderAddons extends AbstractAuditableCustom<AppUser,Long>{
	...
	public static OrderAddons fromJson(final JsonElement element,final FromJsonHelper fromJsonHelper,final Long orderId, LocalDateTime startDate, Long contractId) {
