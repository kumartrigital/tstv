...
public class ChargeCodeData {
	...
	public ChargeCodeData(final Long id ,final String chargeCode, final String contractPeriod, final String billFrequencyCode) {
	...
	public ChargeCodeData(Long id, String chargeCode, String chargeDescription,
			...
			Integer taxInclusive, String billFrequencyCode,Integer isAggregate) {
		this.id = id;
		this.chargeCode = chargeCode;
		this.chargeDescription = chargeDescription;
	...
	public ChargeCodeData(Long id, String chargeCode, String chargeDescription,
			String chargeType, Integer chargeDuration, String durationType,
			Integer taxInclusive, String billFrequencyCode,String contractType ,Integer units,Integer isAggregate ) {
		this.id = id;
		this.chargeCode = chargeCode;
		this.chargeDescription = chargeDescription;
		this.chargeType = chargeType;
