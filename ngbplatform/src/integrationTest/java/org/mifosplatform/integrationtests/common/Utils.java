...
public class Utils {
    ...
    private static final String LOGIN_URL = "/ngbplatform/api/v1/authentication?username=billing&password=password&tenantIdentifier=default";
    ...
    public static String loginIntoServerAndGetBase64EncodedAuthenticationKey() {
        try {
            ...
            assertThat("Failed to login into ngb platform", StringUtils.isBlank(json), is(false));
            ...
            if (e instanceof HttpHostConnectException) {
                ...
                fail("Failed to connect to ngb platform:"+hh.getMessage());
            }
